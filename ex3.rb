...
# Print the results of a math inequality to STDOUT.
puts 3 + 2 < 5 - 7
...
# Use the comma operator to output multiple values (a string and a boolean—the result of some math) to STDOUT.
